<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="portal.aspx.cs" Inherits="Web_ViajesOnTour.Sesion.portal" %>
                ...
                <ul class="nav" id="side-menu">
                    <li>
                        ...
                        <div class="user-section">
                            ...
                            <div class="user-info">
                                <div>
                                    <asp:Label ID="lbl_rut" runat="server" Text="Label"></asp:Label> <strong><asp:Label ID="lbl_nombre" runat="server" Text="Label"></asp:Label></strong></div>
